...
&ensp;
![Experience](https://img.shields.io/badge/Experience-1--2%20Years-A8D5B5?style=flat-square&labelColor=0F2137)
&ensp;
![Projects](https://img.shields.io/badge/Shipped%20Projects-20+-A8D5B5?style=flat-square&labelColor=0F2137)
&ensp;
...
class IbrahimElShishtawy extends FlutterDeveloper {
  ...
  final String experience = "1–2 years, 20+ shipped apps";
...
2024 ────────────────────────────────────────────► Now
  │                    │                    │
  ▼                    ▼                    ▼
Started Flutter    Shipped multiple      Built full-stack
& Dart, learned     production apps      products: real-estate
core state mgmt     (chat, education,    accounting, education
patterns & Clean    e-commerce, media)   platforms, streaming
Architecture         + explored Firebase   apps & an AI-powered
basics                & Supabase backends  personal assistant
```
...
| | |
|---|---|
| ⏱️ &nbsp;**Experience** | 1–2 years hands-on Flutter development |
| 📦 &nbsp;**Shipped** | 20+ public repositories, from MVPs to full production apps |
| 🧩 &nbsp;**Range** | Chat apps · education platforms · streaming · fintech · e-commerce · IoT/AI integrations |
| 🔁 &nbsp;**Growth** | Started with GetX & simple CRUD apps → now building with Bloc/Riverpod, Supabase/Firebase backends, and Clean Architecture |
...
![Supabase](https://img.shields.io/badge/Supabase-0F2137?style=flat-square&logo=supabase&logoColor=7EB8D4)
...
### 🏠&nbsp; عقار المصريين — Real Estate Accounting

A smart accounting solution for real-estate companies: contract management, financial tracking, and clear reporting to streamline real-estate operations end-to-end.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Contracts-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Financial%20Tracking-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Reporting-0F2137?style=flat-square"/>
</p>

<a href="https://github.com/ibrahimelshishtawy?tab=repositories">🔗 View on GitHub</a>

</td>
<td width="50%" valign="top">

### 🏫&nbsp; TeacherHub — Classroom Management Platform

A modern education platform that simplifies classroom management, lesson planning, and student communication — with tools for scheduling, resource sharing, and progress tracking.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Scheduling-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Resource%20Sharing-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Progress%20Tracking-0F2137?style=flat-square"/>
</p>

<a href="https://github.com/ibrahimelshishtawy/TeacherHub">🔗 View on GitHub</a>
...
### 🤖&nbsp; IBRA-AI — AI-Powered Personal Assistant <sub>(private)</sub>

A personal productivity & development assistant powered by AI, integrating Gemini for smart, context-aware assistance — full-stack with a Node.js backend.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Node.js-0F2137?style=flat-square&logo=node.js&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/TypeScript-0F2137?style=flat-square&logo=typescript&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Gemini%20AI-0F2137?style=flat-square"/>
</p>
...
### 📖&nbsp; QuranGlow — Offline-First Quran App

A Flutter app for reading, listening to, and reflecting on the Quran seamlessly, whether online or fully offline — built for a smooth, distraction-free experience.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Offline%20First-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Audio%20Playback-0F2137?style=flat-square"/>
</p>
...
### 🎓&nbsp; تولاب (Tawlab) — Student Materials Hub

A student-focused Flutter app for managing academic materials, built on Supabase with a custom API and a clean, intuitive UI.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Supabase-0F2137?style=flat-square&logo=supabase&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Custom%20API-0F2137?style=flat-square"/>
</p>
...
### 🎬&nbsp; إتفراج (Etfarrag) — Streaming Platform

A destination for discovering and watching content anytime, anywhere — smooth streaming, high-quality video, and a continuously updated library.

<p>
<img src="https://img.shields.io/badge/Flutter-0F2137?style=flat-square&logo=flutter&logoColor=7EB8D4"/>
<img src="https://img.shields.io/badge/Video%20Streaming-0F2137?style=flat-square"/>
<img src="https://img.shields.io/badge/Media%20Library-0F2137?style=flat-square"/>
</p>
...
|---|---|---|
| **هوشها** | Smart personal finance & budgeting app | Flutter |
| **كويك بيت** | Food/shopping app template | Flutter · Supabase · Bloc |
| **نظام الاختبار والامتحان** | Exam & test management system | Flutter |
| **نيوزسكوب** | A smart window on world news | Flutter |
| **لوحة تحكم إدارة المصنع** | Factory management dashboard with API-driven data & animations | Flutter · Bloc |
| **Sawa_chat** | Real-time chat app template | Flutter · Firebase |
| **متجر (Store App)** | E-commerce app integrated with a weather API | Flutter |
| **Freegosy** *(fork)* | Cross-platform app for browsing RomM libraries, downloading games & emulators with auto save-sync | Flutter |
| **qr_trans** *(fork)* | File transfer tool over QR codes | Flutter |
| **spot_the_spy** *(fork)* | Multiplayer word-based social deduction game | Flutter |

</div>

<div align="center">
<sub>Full list of 20+ repositories available on my <a href="https://github.com/ibrahimelshishtawy?tab=repositories">GitHub profile</a>.</sub>
</div>
